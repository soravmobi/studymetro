...
.R_content .col-sm-3.control-label {
  text-align: left;
}
.head_fair > h3 {
  font-size: 20px;
...
.table_in_box tr:last-child td{
  font-weight: bold;
}
.table_in_box td:first-child{
  font-size: 14px;
  color: #fff;
   background-color: #30acec !important;
   text-align: left;
}
.table_in_box tr:nth-child(2n+2) {
...
.table_in_box input[type="checkbox"]{
  display: inline-block;
  vertical-align: top;
}
.sponser_box .blog_box_content1 {
  margin-top: 80px;
}
.R_sec .commn_btn {
...
.fair_head > h2::before {
  background: #30acec none repeat scroll 0 0;
  bottom: -4px;
  content: "";
  height: 4px;
  left: 0;
...
.left_sec li::after , .right_sec li::after {
  content: "";
...
.common_head.footer_head.include_head {
  padding: 0;
}
.foot_address1 {
  display: inline-block;
...
.foot_address1:last-child:after{
  display: none;
}
.foot_address1 > h3 {
  font-size: 18px;
...
.clearfix.teammember_list a {
  color: #666;
}
.clearfix.teammember_list i{
  font-size: 14px;
  color: #666;
}
.contct_sec h2 {
