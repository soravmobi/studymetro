                ...
                <div class="container">
                    ...
                    <div class="col-md-9 col-sm-9">
                      <div class="right_dashboard">
                        <form role="form" method="post" action="<?php echo base_url('university/edit-appointment/'.$details['id']); ?>" id="program_form">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control <?php if(form_error('type')) { echo 'valid_error'; } ?>" name="type">
                          ...
                          <option value="1" <?php if($details['type']==1){ echo 'selected'; } ?>>Indian Education Fair/ School Fair</option>
                          <option value="2" <?php if($details['type']==2){ echo 'selected'; } ?>>Talk to Study Metro though Skype/ Phone</option>
                          <option value="3" <?php if($details['type']==3){ echo 'selected'; } ?>>Hired Shared Resource</option>
                          <option value="4" <?php if($details['type']==4){ echo 'selected'; } ?>>Local Marketing via Digital, Paper, Radio Ads</option>
                          <option value="5" <?php if($details['type']==5){ echo 'selected'; } ?>>Shared CRM</option>
                          <option value="6" <?php if($details['type']==6){ echo 'selected'; } ?>>Marketing Material Printing and Courier In india</option>
                          <option value="7" <?php if($details['type']==7){ echo 'selected'; } ?>>Meet with SM Agents</option>
                          <option value="8" <?php if($details['type']==8){ echo 'selected'; } ?>>Open Study Centre</option>
                        </select>
                      </div>
                  </div>
                </div>
