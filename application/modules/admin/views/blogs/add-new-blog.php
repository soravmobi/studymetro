...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'add_new_blog_header'); ?>
    ...
    <div class="row">
    	<div class="col-md-12">
	        ...
	        <div class="box box-primary">
	          <!-- form start -->
	          <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/blogs/addBlog">
	          ...
	          <!-- Validation error and flash data -->
	            ...
	            <button type="submit" class="btn btn-primary" title="Add Blog">ADD</button>
