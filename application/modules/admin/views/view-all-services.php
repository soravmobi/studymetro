...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'view_all_services_header'); ?>
    	...
    	<div class="col-xs-12">
	      <div class="box box-primary">
	        <div class="box-header">
	          <h3 class="box-title"><?php echo sprintf(ALL_DATA, 'Services'); ?></h3>
	          <a href="<?php cms_url('admin/services/add-new'); ?>" class="addNewAdmin" title="Add New Service">Add New</a>
	          <div class="box-tools">
	            <div class="input-group customInputGroups" style="width: 150px;">
	              <form action="<?php cms_url('admin/services/view-all'); ?>" method="get">
	          ...
	          <table class="table table-hover">
	            ...
	            ?>
	            	<tr>
		              ...
		              <td>
		              	<span>&nbsp;</span>
		              	<a href="<?php cms_url('admin/services/delete/'.$val['id']); ?>" title="Delete Testimonial" onclick="if(!confirm('Are you sure you want to delete this testimonial ?')) return false;">
	            ...
	            <?php } else { ?>
	            	<tr>
	            		<td colspan="5" align="center"><?php echo sprintf(NO_RECORDS_FOUND, 'services') ?></td>
	            	</tr>
	            <?php } ?>
	          </table>
	        </div><!-- /.box-body -->
