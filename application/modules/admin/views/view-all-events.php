...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'view_all_events_header'); ?>
    	...
    	<div class="col-xs-12">
	      <div class="box box-primary">
	        <div class="box-header">
	          <h3 class="box-title"><?php echo sprintf(ALL_DATA, 'Events'); ?></h3>
	          <a href="<?php cms_url('admin/events/add-new'); ?>" class="addNewAdmin" title="Add New Event">Add New</a>
	          <div class="box-tools">
	            <div class="input-group customInputGroups" style="width: 150px;">
	              <form action="<?php cms_url('admin/events/view-all'); ?>" method="get">
	          ...
	          <table class="table table-hover">
	            ...
	            ?>
	            	<tr>
		              ...
		              <td><?php echo $val['posted_in']; ?></td>
		              <td><?php echo $val['content']; ?></td>
		              <td><?php echo convertDateTime($val['added_date']); ?></td>
		              <td>
		              	<span>&nbsp;</span>
		              	<a href="<?php cms_url('admin/events/delete/'.$val['id']); ?>" title="Delete Event" onclick="if(!confirm('Are you sure you want to delete this testimonial ?')) return false;">
	            ...
	            <?php } else { ?>
	            	<tr>
	            		<td colspan="5" align="center"><?php echo sprintf(NO_RECORDS_FOUND, 'events') ?></td>
	            	</tr>
	            <?php } ?>
	          </table>
	        </div><!-- /.box-body -->
