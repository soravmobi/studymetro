...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'view_all_feedbacks_header'); ?>
    	...
    	<div class="col-xs-12">
	      <div class="box box-primary">
	        <div class="box-header">
	          <h3 class="box-title"><?php echo sprintf(ALL_DATA, 'Feedbacks'); ?></h3>
	          <div class="box-tools">
	            <div class="input-group customInputGroups" style="width: 150px;">
	              <form action="<?php cms_url('admin/feedbacks/view-all'); ?>" method="get">
	          ...
	          <table class="table table-hover">
	            ...
	            ?>
	            	<tr>
		              ...
		              <td><a href="javascript:void(0);" class="content_tooltip" data-placement="auto" data-toggle="tooltip" title="<?php echo $val['suggestion']; ?>"><?php echo substr($val['suggestion'],0, 25); ?></a></td>
		              <td><?php echo convertDateTime($val['added_date']); ?></td>
		            </tr>
	            <?php } /* End foreach */ ?>
	            <?php } else { ?>
	            	<tr>
	            		<td colspan="5" align="center"><?php echo sprintf(NO_RECORDS_FOUND, 'feedbacks') ?></td>
	            	</tr>
	            <?php } ?>
	          </table>
	        </div><!-- /.box-body -->
