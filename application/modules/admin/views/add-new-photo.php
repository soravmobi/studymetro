...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'add_new_photo_header'); ?>
    ...
    <div class="row">
    	<div class="col-md-12">
	        ...
	        <div class="box box-primary">
	          <!-- form start -->
	          <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/photos/addphotos">
	          ...
	          <!-- Validation error and flash data -->
		            ...
		            <div class="col-md-12">
		            	<div class="col-md-6">
			                <div class="form-group photo_1">
			                  ...
			                  <input type="file" onchange="readURL(this,'jpg|jpeg|png|gif','')" name="photos[]" required class="form-control margin_bottom10"/>
			                </div>
			            </div>
	            ...
	            <button type="submit" class="btn btn-primary" title="Upload Photo">UPLOAD</button>
...
$('body').on('click','.add-photos',function(){
	var photohtml_1 = '<input type="file" name="photos[]" onchange="readURL(this,&quot;jpg|jpeg|png|gif&quot;,&quot;&quot;)" required class="form-control margin_bottom10" />';
