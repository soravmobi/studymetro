...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'view_all_enquiries_header'); ?>
    	...
    	<div class="col-xs-12">
	      <div class="box box-primary">
	        <div class="box-header">
	          <h3 class="box-title"><?php echo sprintf(ALL_DATA, 'Enquiries'); ?></h3>
	          <div class="box-tools">
	            <div class="input-group customInputGroups" style="width: 150px;">
	              <form action="<?php cms_url('admin/enquiries/view-all'); ?>" method="get">
	        ...
	        <div class="box-body table-responsive no-padding">
	          <table class="table table-hover">
	            ...
	            <?php } else { ?>
	            	<tr>
	            		<td colspan="5" align="center"><?php echo sprintf(NO_RECORDS_FOUND, 'enquiries') ?></td>
	            	</tr>
	            <?php } ?>
	          </table>
	        </div><!-- /.box-body -->
