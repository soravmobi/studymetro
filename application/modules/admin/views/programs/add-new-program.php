...
<div class="content-wrapper">
  ...
  <?php admin_content_header($meta_title, $small_text, 'add_new_program_header'); ?>
    ...
    <div class="row">
    	<div class="col-md-12">
	        ...
	        <div class="box box-primary">
	          <!-- form start -->
	          <form role="form" method="post" action="<?php echo base_url(); ?>admin/programs/insertProgram" id="program_form">
		            ...
		            <div class="col-md-12">
		            	<div class="col-md-6">
			                <div class="form-group">
			                  ...
			                  <input type="text" required name="program_name" class="form-control" id="program_name" placeholder="Enter Program Name" />
			                </div>
			            </div>
			            <div class="col-md-6">
			                <div class="form-group">
